...
export const BLOCK_STYLES: Record<BlockType, { color: string; icon: React.ReactNode; label: string }> = {
  ...
  [BlockType.MAPA]: {
    color: 'bg-emerald-400/10 border-emerald-400/30 text-emerald-300',
  ...
  [BlockType.NUCLEO]: {
    color: 'bg-sky-400/10 border-sky-400/30 text-sky-300',
  ...
  [BlockType.PAUSAS]: {
    color: 'bg-slate-400/10 border-slate-400/30 text-slate-300',
    label: 'Pausas de pensamiento',
    icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
  },
  [BlockType.TRAMPAS]: {
    color: 'bg-orange-400/10 border-orange-400/30 text-orange-300',
    label: 'Trampas de comprensión',
    icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
  },
  [BlockType.SABIAS]: {
    color: 'bg-sky-400/20 border-sky-400/40 text-sky-200',
    label: '¿Lo sabías?',
  ...
  [BlockType.RELECTURA]: {
    color: 'bg-pink-400/10 border-pink-400/30 text-pink-300',
    label: 'Relectura obligatoria',
    icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>
  },
  [BlockType.EMOCIONAL]: {
    color: 'bg-indigo-400/10 border-indigo-400/30 text-indigo-300',
    label: 'Checklist emocional',
    icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg>
  },
  [BlockType.AUTOTEST]: {
    color: 'bg-slate-700 border-slate-600 text-slate-200',
    label: 'Auto test',
